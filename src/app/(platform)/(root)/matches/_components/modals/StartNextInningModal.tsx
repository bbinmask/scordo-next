...
export const StartNextInningModal = ({
  ...
  const battingPlayers = useMemo(() => {
    return lastBatted === "teamA" ? match.teamB.players : match.teamA.players;
  }, [match]);

  const bowlingPlayers = useMemo(() => {
    return lastBatted === "teamA" ? match.teamA.players : match.teamB.players;
  }, [match]);
  ...
  const { data, isLoading } = useQuery<PlayerWithUser[]>({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="p-0">
        ...
        <div className="hide_scrollbar max-h-[60vh] flex-1 overflow-y-auto px-6 py-4 font-[poppins]">
            ...
            <div className="animate-in slide-in-from-right-4 space-y-8 duration-300">
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        className="w-full cursor-pointer appearance-none rounded-xl border border-white/10 bg-white/5 px-4 py-3 font-[inter] text-sm font-semibold outline-none focus:ring-2 focus:ring-green-500"
                      >
              ...
              <div className="flex items-start gap-4 rounded-3xl border border-green-500/20 bg-green-500/5 p-6">
                ...
                <p className="text-xs leading-relaxed font-medium tracking-wide text-slate-500 uppercase dark:text-slate-400">
                  Ready for the next inning. Starting this inning will{" "}
