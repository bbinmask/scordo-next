...
export const ActionButton = ({
  ...
  return (
    ...
    >
      ...
      {Icon && (
        <Icon className="h-5 w-5 text-slate-500 transition-colors group-hover:text-green-600 dark:group-hover:text-green-400" />
      )}{" "}
    </button>
  );
};
